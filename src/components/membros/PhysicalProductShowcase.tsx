      ...
      <section className="py-6 px-4">
        ...
        >
          ...
          <div className="flex-1 min-w-0 space-y-1">
            ...
            {offer.description && (
              <p className="text-xs text-gray-400 leading-relaxed line-clamp-2">{offer.description}</p>
            )}
            <span
        ...
        <div className="fixed inset-0 z-50 bg-black/60 flex items-end sm:items-center justify-center animate-in fade-in duration-200">
          <div className="relative bg-white w-full max-w-lg sm:rounded-2xl rounded-t-2xl max-h-[90vh] overflow-y-auto animate-in slide-in-from-bottom-4 duration-300">
            ...
            <div className="p-6 space-y-4">
              ...
              {offer.description && (
                <p className="text-sm text-gray-500 leading-relaxed whitespace-pre-line">{offer.description}</p>
              )}
              {offer.price != null && (
              ...
              <button
                onClick={() => { setShowSalesPage(false); setPaymentOpen(true); }}
